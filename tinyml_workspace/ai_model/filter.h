 ...
 * @note    Sample rate dau vao = 25Hz (da average 4 mau tu MAX30102 100Hz)
 */
...
#define FILTER_FS_HZ            25.0f   // tan so lay mau dau vao filter task
#define ZSCORE_WINDOW_SIZE      200     // 200 mau = 8s @ 25Hz
