...
bool max30102_init(sl_i2cspm_t *i2cspm)
{
  ...
  // 3. Cấu hình FIFO (0x4F: SMP_AVE=4, ROLLOVER=1, FIFO_A_FULL=15)
  if (!max30102_write_reg(i2cspm, MAX30102_REG_FIFO_CONFIG, 0x5F)) {
  ...
  app_log_info("[MAX30102 Check] FIFO_CFG: 0x%02X (Mong muon: 0x4F)\r\n", check_fifo);
